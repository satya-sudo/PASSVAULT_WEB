...
SECRET_KEY = os.environ.get('SECRET_KEY') if os.environ.get('SECRET_KEY') else 'tp@0pip9(17uu9+0a8yyc=5im7+ryqtiz!10wohi=c!2!^ej&b'
...
AUTH_USER_MODEL = 'passvault.User'
...
EMAIL_HOST_PASSWORD = os.environ.get('EAMIL_HOST_PASS')